...
%%| fig-width: 3.6
graph TD
  A[BIM Model<br>RVT / DWG file] --> B[Model Derivative API<br>getObjectTree / getData]
  A --> C[Tandem<br>Digital Twin]
  C --> D[Sensor Streams<br>temperature / CO₂ / energy]
  B -- objectId --> C
  D -- time-series data --> E[R Analysis<br>httr2 + dplyr]
  B -- metadata --> E
```
...
## Joining BIM Properties with Twin Elements
