...
The book is organised into seven parts. You don't have to read them in order, each chapter is reasonably self-contained, but the parts do build on each other if you want the full picture.

| Part | Chapters | What you'll do |
|----|----|----|
| **Front Matter** | Motivation, Getting Started, Acknowledgements | Understand the why; set up credentials |
