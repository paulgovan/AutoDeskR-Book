...
The [`mcpr`](https://github.com/devOpifex/mcpr) [@R-mcpr] package provides the MCP transport layer for R. Install it from GitHub:
...
Add more tools by repeating the `mcp_tool()` pattern before calling `mcp_serve()`. Here are two more useful examples:
