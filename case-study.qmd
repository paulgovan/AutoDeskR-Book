...
# Case Study: From DWG to Shiny Dashboard
...
```{r}
#| eval: false
# Aggregate area by layer
layer_totals <- aggregate(area ~ layer, data = layers_df, FUN = sum)
layer_totals <- layer_totals[order(-layer_totals$area), ]
...
![Bar chart showing bounding-box area by DWG layer, with A-SITE dominating at ~197k units²](images/layers_plot.png){fig-alt="Horizontal bar chart of DWG layer areas"}
