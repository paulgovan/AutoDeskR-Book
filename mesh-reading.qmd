...
%%| fig-width: 3.0
flowchart TB
  A[CAD file<br>in OSS bucket] --> B[translateObj / translateStl<br>Model Derivative]
  B --> C[downloadFile<br>arial.obj]
  C --> D[vcgImport<br>tmesh3d object]
  D --> E[Analyse<br>metrics / visualise / compare]
```
...
::: callout-note
APS requires URNs to be Base64-encoded. `jsonlite::base64_enc()` handles this. See [Model Derivative](model-derivative.qmd#translate-to-obj) for the full explanation.
:::
